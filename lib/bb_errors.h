...
#define AES_CBC_DECRYPT_ERROR                       0x000800000
#define RANDOM_INIT_ERROR                           0x000900000
#define RANDOM_GENERATING_RANDOM_BLOCK_ERROR        0x000A00000
#define AES_CBC_ENCRYPT_ERROR                       0x000B00000
#define SHA256_ERROR                                0x000C00000
#define RANDOM_FREEING_ERROR                        0x000D00000
...
#define REO_FRAGMENTED                              0x0D0000000
#define REO_BUF_ADJUSTED                            0x0E0000000
#define REO_SNAPSHOT_URL_TOO_LONG                   0x0F0000000
#define REO_CANNOT_FETCH_SNAPSHOT                   0x010000001
#define REO_SNAPSHOT_TOO_BIG_FOR_BUF                0x010000002
...
#define WIRE_CBOX_FIND_FAIL                         0x100000001
#define WIRE_CBOX_DECRYPT_FAIL                      0x100000002
#define WIRE_DECODE_MSG_FAIL                        0x100000003
#define WIRE_GET_SELF_ENGINE_FAIL                   0x100000004
#define WIRE_WCALL_INIT_FAIL                        0x100000005
#define WIRE_OBTAINING_WCALL_HANDLE_FAIL            0x100000006
#define WIRE_LOOKUP_CONV_FAIL                       0x100000007
#define WIRE_JSON_DECODE_FAIL                       0x100000008
#define WIRE_JSON_ARRAY_FAIL                        0x100000009
#define WIRE_JSON_ARRAY_EXPECTED_FAIL               0x10000000A
#define WIRE_HTTP_CLIENT_ALLOC_FAIL                 0x10000000B
#define WIRE_HTTP_REQ_FAIL                          0x10000000C
#define WIRE_UNKNOWN_ASSET_ID                       0x10000000D
#define WIRE_ERROR_STARTING_REQUEST                 0x10000000E
#define WIRE_ERROR_SETTING_ASSET_TOKEN              0x10000000F
#define WIRE_ERROR_CREATING_REQUEST                 0x100000010
#define WIRE_ASSET_KEY_NOT_SET                      0x100000011
#define WIRE_ASSET_TOKEN_NOT_SET                    0x100000012
#define WIRE_ASSET_DOMAIN_NOT_SET                   0x100000013
#define WIRE_ASSET_ID_NOT_SET                       0x100000014
#define WIRE_CANNOT_OPEN_DEST_FILE                  0x100000015
#define WIRE_CANNOT_DOWNLOAD_ASSET                  0x100000016
#define WIRE_CANNOT_PARSE_ASSET_LOCATION            0x100000017
#define WIRE_NO_REDIRECT_FOUND                      0x100000018
#define WIRE_NO_302_RECEIVED                        0x100000019
#define WIRE_CANNOT_FETCH_ASSET                     0x10000001A
#define WIRE_CANNOT_OPEN_SRC_FILE                   0x10000001B
#define WIRE_CANNOT_POST_ASSET                      0x10000001C
#define WIRE_INVALID_STATUS_CODE_RECEIVED           0x10000001D
#define WIRE_CANNOT_ADD_BODY                        0x10000001E
#define WIRE_CANNOT_ADD_HEADER                      0x10000001F
#define WIRE_PROTOBUF_BUF_TOO_SMALL                 0x100000020
#define WIRE_ERROR_PACKING_PROTOBUF                 0x100000021
#define WIRE_INVALID_ASSET_TYPE                     0x100000022
#define WIRE_ERROR_GETTING_API_VERSION              0x100000023
#define WIRE_BUF_TOO_SMALL_FOR_PADDING              0x100000024
